...
const HomeView = () => {
  ...
  const fallback = {
    ...
    diffItems: [
      { title: "Higiene real", text: "Reduce salpicaduras y ayuda a mantener el baño limpio por más tiempo." },
      { title: "Material premium", text: "Goma resistente, antideslizante y preparada para uso intensivo." },
      { title: "Reemplazo mensual", text: "Las alfombrillas se reemplazan cada 30 días para asegurar máxima higiene y efectividad." },
    ],
  };
    ...
    <div className="home-view">
      ...
      <main className="home-content">
        ...
        <section className="intro-section">
          <h2>¿Quiénes somos?</h2>
          <p>
            En <strong>DryMat</strong> desarrollamos alfombras de goma diseñadas específicamente para mingitorios,
            con el objetivo de mejorar la higiene, reducir salpicaduras y optimizar la limpieza.
          </p>
          <p>
            Nuestros productos combinan <strong>funcionalidad, durabilidad y diseño</strong>, ofreciendo una solución
            práctica tanto para espacios comerciales como institucionales.
          </p>
        </section>
        ...
        <section className="clientes-section">
          ...
          <div className="clientes-grid">
            <div className="cliente-item">
              <img src={sanAndresImg} alt="Instalación de DryMat en mingitorio" />
        ...
        <section className="objetivo-section">
          ...
          <p>
            Mejorar la experiencia en baños públicos y privados con una solución simple, efectiva y duradera.
          </p>
          <p>Si estás buscando elevar el estándar de higiene en tu espacio, DryMat es una opción pensada para uso real.</p>
        </section>

        <section className="contacto-cta">
          <h2>¿Querés una cotización?</h2>
          <p>Escribinos por WhatsApp o completá el formulario de contacto y te respondemos a la brevedad.</p>
